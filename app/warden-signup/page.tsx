...
export default function WardenSignupPage() {
  ...
  const handleSignup = async () => {
    if (!form.name || !form.email || !form.phone || !form.hostel || !form.password || !form.confirmPassword || !form.verificationCode) {
    ...
    try {
      ...
      if (!res.ok) {
        alert(data.message || "Failed to create warden account");
        return;
      }
      ...
      <section className="auth-shell">
        ...
        <div className="auth-content">
          <header className="text-center">
            ...
            <p className="mt-1 text-xs text-gray-500 sm:text-sm">Secure student gate pass system</p>
          </header>
          ...
          <div className="glass-card auth-card">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase text-blue-600">Warden Signup</p>
                <h2 className="text-lg font-semibold text-gray-800">Create Warden Account</h2>
              </div>
            </div>
            ...
            <div className="mt-3">
              ...
              <input name="hostel" value={form.hostel} onChange={handleChange} type="text" placeholder="Enter hostel name" autoComplete="organization" className="mt-1 w-full rounded-xl bg-gray-100 p-3 text-gray-800 outline-none focus:ring-2 focus:ring-blue-400" />
            </div>
            ...
            <div className="mt-3">
              ...
              <input name="verificationCode" value={form.verificationCode} onChange={handleChange} type="password" placeholder="Enter warden code" autoComplete="off" className="mt-1 w-full rounded-xl bg-gray-100 p-3 text-gray-800 outline-none focus:ring-2 focus:ring-blue-400" />
            </div>

...
export default function HodSignupPage() {
  ...
  const handleSignup = async () => {
    ...
    try {
      const res = await fetch("/api/auth/hod-signup", {
        method: "POST",
      ...
      if (!res.ok) {
        alert(data.message || "Failed to create HOD account");
        return;
      }
        ...
        <div className="auth-content">
          ...
          <div className="glass-card auth-card">
            <div className="mb-4 flex items-center gap-3">
              ...
              <div>
                <p className="text-xs font-semibold uppercase text-blue-600">HOD Signup</p>
                <h2 className="text-lg font-semibold text-gray-800">Create HOD Account</h2>
              </div>
            </div>
            ...
            <div className="mt-3">
              ...
              <input name="verificationCode" value={form.verificationCode} onChange={handleChange} type="password" placeholder="Enter HoD code" autoComplete="off" className="mt-1 w-full rounded-xl bg-gray-100 p-3 text-gray-800 outline-none focus:ring-2 focus:ring-blue-400" />
            </div>
